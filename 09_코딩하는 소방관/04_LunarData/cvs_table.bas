Attribute VB_Name = "cvs_table"
'2018.1.11일 Update
'  - 2030년까지의 오류 수정 하였습니다.
'  - 2040년까지 변환가능하도록 배열 추가 하였습니다.
'  by http://www.acronet.kr (All free for Free distribution as Jesus)

'※ 사용법
'아래 사용자 정의 함수를 모듈시트에 복사하여 붙여넣으세요.
'그리고 양력을 음력으로 고치려면=suntolun(2005,11,29)
'음력을 양력으로 고치려면=luntosun(2005,10,28,0) 라고 입력하면
'변환시켜줍니다. 여기서 마지막의 0은 음력을 양력으로 고칠 때만
'사용되는 것으로 음력으로 윤달일경우는 1, 아닌경우는 0을 사용합니다.
'※ 함수 만드는 방법
'마이크로소프트 엑셀 -> 도구 -> 매크로기록(아무 이름이나) -> 매크로 편집에서
'모두 지우고 아래 함수 붙여 넣는다.

Option Explicit
Dim EM(1 To 140, 1 To 13) As Integer, MT(12) As Integer
Dim VM(6)           As Integer
...
Sub CalenderData()
    ...
    'EM(?,?) 배열은 1901년부터 2040년까지의 음력 각달의 크기를 VM(6) 배열값으로 저장하고 마지막 배열은 음력 총일수를 저장함
    ...
    EM(65, 1) = 1: EM(65, 2) = 2: EM(65, 3) = 1: EM(65, 4) = 2: EM(65, 5) = 1: EM(65, 6) = 1: EM(65, 7) = 2: EM(65, 8) = 1: EM(65, 9) = 1: EM(65, 10) = 2: EM(65, 11) = 2: EM(65, 12) = 2: EM(65, 13) = 354        '1965년
    EM(66, 1) = 1: EM(66, 2) = 2: EM(66, 3) = 5: EM(66, 4) = 2: EM(66, 5) = 1: EM(66, 6) = 1: EM(66, 7) = 2: EM(66, 8) = 1: EM(66, 9) = 1: EM(66, 10) = 2: EM(66, 11) = 2: EM(66, 12) = 1: EM(66, 13) = 383        '1966년
    ...
    EM(117, 1) = 1: EM(117, 2) = 2: EM(117, 3) = 1: EM(117, 4) = 2: EM(117, 5) = 3: EM(117, 6) = 2: EM(117, 7) = 1: EM(117, 8) = 2: EM(117, 9) = 1: EM(117, 10) = 2: EM(117, 11) = 2: EM(117, 12) = 2: EM(117, 13) = 384        '2017년 오류 수정
    ...
    EM(127, 1) = 1: EM(127, 2) = 2: EM(127, 3) = 1: EM(127, 4) = 2: EM(127, 5) = 1: EM(127, 6) = 1: EM(127, 7) = 2: EM(127, 8) = 1: EM(127, 9) = 1: EM(127, 10) = 2: EM(127, 11) = 2: EM(127, 12) = 2: EM(127, 13) = 354        '2027년 오류 수정
    EM(128, 1) = 1: EM(128, 2) = 2: EM(128, 3) = 2: EM(128, 4) = 1: EM(128, 5) = 5: EM(128, 6) = 1: EM(128, 7) = 2: EM(128, 8) = 1: EM(128, 9) = 1: EM(128, 10) = 2: EM(128, 11) = 2: EM(128, 12) = 1: EM(128, 13) = 383        '2028년 오류 수정
    EM(129, 1) = 2: EM(129, 2) = 2: EM(129, 3) = 1: EM(129, 4) = 2: EM(129, 5) = 2: EM(129, 6) = 1: EM(129, 7) = 1: EM(129, 8) = 2: EM(129, 9) = 1: EM(129, 10) = 1: EM(129, 11) = 2: EM(129, 12) = 2: EM(129, 13) = 355        '2029년 오류 수정
    EM(130, 1) = 1: EM(130, 2) = 2: EM(130, 3) = 1: EM(130, 4) = 2: EM(130, 5) = 2: EM(130, 6) = 1: EM(130, 7) = 2: EM(130, 8) = 1: EM(130, 9) = 2: EM(130, 10) = 1: EM(130, 11) = 2: EM(130, 12) = 1: EM(130, 13) = 354        '2030년 오류 수정
    EM(131, 1) = 2: EM(131, 2) = 1: EM(131, 3) = 5: EM(131, 4) = 2: EM(131, 5) = 1: EM(131, 6) = 2: EM(131, 7) = 2: EM(131, 8) = 1: EM(131, 9) = 2: EM(131, 10) = 1: EM(131, 11) = 2: EM(131, 12) = 1: EM(131, 13) = 384        '2031년 추가
    EM(132, 1) = 2: EM(132, 2) = 1: EM(132, 3) = 1: EM(132, 4) = 2: EM(132, 5) = 1: EM(132, 6) = 2: EM(132, 7) = 2: EM(132, 8) = 1: EM(132, 9) = 2: EM(132, 10) = 2: EM(132, 11) = 1: EM(132, 12) = 2: EM(132, 13) = 355        '2032년 추가
    EM(133, 1) = 1: EM(133, 2) = 2: EM(133, 3) = 1: EM(133, 4) = 1: EM(133, 5) = 2: EM(133, 6) = 1: EM(133, 7) = 2: EM(133, 8) = 1: EM(133, 9) = 2: EM(133, 10) = 2: EM(133, 11) = 5: EM(133, 12) = 2: EM(133, 13) = 384        '2033년 추가
    EM(134, 1) = 1: EM(134, 2) = 2: EM(134, 3) = 1: EM(134, 4) = 1: EM(134, 5) = 2: EM(134, 6) = 1: EM(134, 7) = 2: EM(134, 8) = 1: EM(134, 9) = 2: EM(134, 10) = 2: EM(134, 11) = 2: EM(134, 12) = 1: EM(134, 13) = 354        '2034년 추가
    EM(135, 1) = 2: EM(135, 2) = 1: EM(135, 3) = 2: EM(135, 4) = 1: EM(135, 5) = 1: EM(135, 6) = 2: EM(135, 7) = 1: EM(135, 8) = 1: EM(135, 9) = 2: EM(135, 10) = 2: EM(135, 11) = 1: EM(135, 12) = 2: EM(135, 13) = 354        '2035년 추가
    EM(136, 1) = 2: EM(136, 2) = 2: EM(136, 3) = 1: EM(136, 4) = 2: EM(136, 5) = 1: EM(136, 6) = 4: EM(136, 7) = 1: EM(136, 8) = 1: EM(136, 9) = 2: EM(136, 10) = 2: EM(136, 11) = 1: EM(136, 12) = 2: EM(136, 13) = 384        '2036년 추가
    EM(137, 1) = 2: EM(137, 2) = 2: EM(137, 3) = 1: EM(137, 4) = 2: EM(137, 5) = 1: EM(137, 6) = 1: EM(137, 7) = 2: EM(137, 8) = 1: EM(137, 9) = 1: EM(137, 10) = 2: EM(137, 11) = 1: EM(137, 12) = 2: EM(137, 13) = 354        '2037년 추가
    EM(138, 1) = 2: EM(138, 2) = 2: EM(138, 3) = 1: EM(138, 4) = 2: EM(138, 5) = 1: EM(138, 6) = 2: EM(138, 7) = 1: EM(138, 8) = 2: EM(138, 9) = 1: EM(138, 10) = 1: EM(138, 11) = 2: EM(138, 12) = 1: EM(138, 13) = 354        '2038년 추가
    EM(139, 1) = 2: EM(139, 2) = 2: EM(139, 3) = 1: EM(139, 4) = 2: EM(139, 5) = 5: EM(139, 6) = 2: EM(139, 7) = 1: EM(139, 8) = 2: EM(139, 9) = 1: EM(139, 10) = 2: EM(139, 11) = 1: EM(139, 12) = 1: EM(139, 13) = 384        '2039년 추가
    EM(140, 1) = 2: EM(140, 2) = 1: EM(140, 3) = 2: EM(140, 4) = 2: EM(140, 5) = 1: EM(140, 6) = 2: EM(140, 7) = 2: EM(140, 8) = 1: EM(140, 9) = 2: EM(140, 10) = 1: EM(140, 11) = 2: EM(140, 12) = 1: EM(140, 13) = 355        '2040년 추가
End Sub
...
Function SunToLun(SY As Integer, SM As Long, SD As Long)
    ...
    ' 윤년이면 1을 빼준다. 아래 코멘트 처리한 부분을 변경 by Acronet
    'If SY = 4 * Int(Y / 4) And 30 * SM + SD < 90 Then
    'T = T - 1
    'End If
    If (SY Mod 4) = 0 And (SY Mod 100) <> 0 Or ((SY Mod 400) = 0) Then
        If 30 * SM + SD < 90 Then
            T = T - 1
        End If
    End If
